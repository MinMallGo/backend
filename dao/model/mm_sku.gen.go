...
type MmSku struct {
	...
	RedundancyTitle string    `gorm:"column:redundancy_title;comment:商品 + 规格组合 + 名字" json:"redundancy_title"` // 商品 + 规格组合 + 名字
	...
	Stock           int32     `gorm:"column:stock;comment:商品库存" json:"stock"`                                 // 商品库存
